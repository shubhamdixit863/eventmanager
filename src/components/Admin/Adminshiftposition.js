...
function getData()
{
 ...
 if (check) {NotificationManager.error('All Fields Are Required','Error') ;setLoader(false);return}
    ...
    axios.post(`${process.env.REACT_APP_URL}/ShiftPosition`,shiftposition).then(data=>{
      console.log(data);
...
<Loader
  ...
  <Shiftpositionmodal    isEdit={isEdit} editRecord={editRecord} data={editedData} handleChange={handleChange}  createNewRecord={createNewRecord} setShowModal={setShowModal} showModal={showModal}/>
    </section>
